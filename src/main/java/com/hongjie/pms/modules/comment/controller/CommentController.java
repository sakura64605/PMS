...
public class CommentController {
    ...
    @Idempotent(key = "#request.targetId + '-' + #request.targetType + '-' + #request.content", keyTimeout = 300, message = "评论操作正在处理中，请稍后再试")
    @PostMapping("/create")
     ...
     * 删除评论
     */
    @Idempotent(key = "#id", keyTimeout = 300, message = "删除评论操作正在处理中，请稍后再试")
