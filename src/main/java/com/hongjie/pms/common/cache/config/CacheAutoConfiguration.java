package com.hongjie.pms.common.cache.config;

import com.hongjie.pms.common.cache.DistributedCache;
import com.hongjie.pms.common.cache.RedisKeySerializer;
import com.hongjie.pms.common.cache.StringRedisTemplateProxy;
...
public class CacheAutoConfiguration {
    ...
    @Bean
    // 注册 DistributedCache 类型的 Bean
    public DistributedCache distributedCache(StringRedisTemplateProxy stringRedisTemplateProxy) {
